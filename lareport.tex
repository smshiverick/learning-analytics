...
a student survey. Ideally, it is preferable to obtain behavioural data to 
understand factors that contribute to student performance to avoid potential
bias of self-reports. The development of EDM and LA has primarily been driven 
by big data in education and the shift toward online learning. Much LA/EDM
research data is collected within a learning management system (LMS), virtual 
learning environment (VLE), or massive open online course (MOOC). Many online 
platforms automatically track student behavior and participation in real time, 
such as by: login frequency, resources accessed, time to solve tasks, response 
time to questions, number of discussion posts, chat messages, or questions 
submitted to instructors. Merging LMS data with institutional data about 
performance (i.e., grades) can provide valuable insights about the conditions 
for successful learning and inform decision making \cite{hora19}. In addition 
to quantitative measures about activities and behavior, meaningful analytics 
systems will include qualitative measures about learning content or affective 
states (e.g., boredom, frustration, confusion) to model student engagement in 
learning activities. This information can, in turn, help instructional 
designers to respond to individual differences and construct more 
personalized learning environments \cite{baker14, pardos14, siemens13}. 



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsubsection{Features of Learning} 

Learning is a complex phenomenon that is not always directly observable and 
often inferred from student behavior. Social learning theories have demonstrated 
...
\cite{vygotsky78}. Sociological research has investigated the structure of 
connections in social networks \cite{granovetter73}, Visualizating the 
connections among between students in online learning platforms can help us 
to better understand the role of collaboration in learning \cite{dawson14}. 
Other areas of interest for LA/EDM researchers include increasing (self-)
reflection, (self-)awareness, and recommending educational resources 
