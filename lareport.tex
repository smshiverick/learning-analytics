...
All models were constructed in \textit{R} (using \textit{Rstudio}) following
examples from \emph{An Introduction to Statistical Learning with Applications 
in R} \cite{jamesetal13}. After preliminary exploration of the data, the sample 
