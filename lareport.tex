...
that, in addition to course assessments such as the number of quizzes 
successfully passed, engagement and participation in course activities is 
the most influential predictor of final grades 
\cite{Papamitsiou14, romerozaldivar12}. Furthermore, a student's sense of 
belonging is essential for engagement and improved satisfaction, which in turn,
can reduce student dropout.

This study compares several predictive model to understand which model is
best for identifying the set of features that best predicts student performance. 

student engagement, characteristics that contribute to successful performance, 
