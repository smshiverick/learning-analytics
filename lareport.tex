...
repository \cite{cortez08}. The dataset included information from a student 
survey and school grade records from courses in mathematics and Portugese. 
The data were fit using several supervised learning regression models 
(described above). The predictors variables of interest were demographic 
variables, family characteristics, and student behaviors (e.g., weekly study 
hours, romantic relationships). The different models explored various 
dimensions of student performance by: (i) Analyzing the combination of 
factors that best predict student performance, (ii) Selecting variables 
most important for predicting performance, and (iii) Identifying the most
accurate and most interpretable model of predicted performance. 
