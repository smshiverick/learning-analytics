...
\begin{figure}[!ht]
  ...
  \caption{Regression Tree Model of Student Performance on Training Set}
  \label{f:Figure4}
\end{figure}
...
three consecutive features (see Figure 4). The resulting regression tree had
7 terminal nodes, with course subject as the root node. Course subject was a 
dummy variable and the branch to the left represents students in the mathematics
course (39\%) and the branch to the right represents students in the Portugese 
course (61\%). In addition to course subject, The mother's education level, 
weekly study time. student absences, and age were used to construct the tree. 
The predicted mean value of student performance was 11 at the root node, and 
...
\begin{figure}[!ht]
  ...
  \caption{Regression Tree Model of Student Performance on Testing Set}
  \label{f:Figure5}
\end{figure}
