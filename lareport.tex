...
extracting knowledge from data \cite{jamesetal13, kuhn13}. The two main branches 
of predictive modeling are supervised learning and unsupervised learning. 
Supervised learning problems involve prediction about a specific outcome or 
target variable (i.e., course grade) when examples of input/output pairs 
...
Clustering can be used to group individuals together based on similar learning 
profiles. The two main approaches for supervised 
