...
origins and emphasis, LA and EDM are complementary approaches that use similar 
methodologies. Together, EDM and LA represent an ecosystem of techniques for 
...
researchers applied a diverse range of descriptive, correlational, and 
...
strategies, attitudes, and affect \cite{papamitsiou14}. The main analytic
approaches used in EDM/LA research include discovery with models, similarity 
grouping, relationship mining, content analysis, and social network analysis 
(SNA) \cite{baker09, siemensbaker12}. Analyses of learner data and patterns
identified within these data are directed at predicting learning outcomes, 
recommending resources, and detecting error patterns \cite{verbert12}. The
output of this research activity has provided valuable resources for various 
stakeholders, namely learners, educators, and educational administrators. 
This paper focuses on predictive modeling of student performance as a form 
of data-driven learning analytics. 
