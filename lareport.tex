...
linear model selected thirteen predictors variables in the training set, only 
six of which significantly predicted performance in the test set. Plans for 
higher education, mother's education level, weekly study time were positively
correlated with performance, whereas course subject, school support, and 
romantic relationships were negatively associated with performance. 
