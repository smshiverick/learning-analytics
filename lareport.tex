...
weekly study time as the next most informative variables, in 
descending order of importance. Plans for higher education was not selected
among the most important variables for predicting student performance, 
In contrast to the single regression tree and random forest model.
...
sets of features as important for predicting student performance. In the 
general linear model, thirteen variables in the training set were selected 
as predictors of performance, and in the test set, only six of these 
predictors were shown to be significant: Course subject, school support, 
plans for higher education, mother's education level, weekly study time, and 
