...
the UC-Irvine machine learning repository. The dataset was collected from
two secondary schools in Portugal and included information from a student 
survey and school grade records \cite{cortez08}. The data were fit using 
several supervised machine learning models (described above). The target 
variable was final course grade in two courses, mathematics and Portugese. 
The predictors variables of interest were demographic variables, family 
...
student performance, (ii) Selecting variables most important for predicting 
performance, and (iii) Identifying the best and most interpretable model of 
