...
\begin{table}
  ...
  (L1) of Student Performance}
  \label{tab:freq}
  \begin{tabular}{lll}
    \toprule    
                        &   Ridge (L2)  & Lasso (L1) \\
    \midrule
    Best lambda (CV)    &    0.746      &  0.071    \\
    MSE                 &   12.788      & 13.895    \\
    \midrule
    \textit{Variables}  & \textit{Coefficient} &  \textit{Coefficient} \\
    \midrule
    Intercept           &   13.539      &   12.899   \\
    Course              &   -1.838      &   -2.058   \\
    School Support      &   -1.171      &   -1.121   \\
    Higher Ed           &    1.409      &    1.534   \\
    Going Out           &   -0.285      &   -0.316   \\
    Mother's Education  &    0.333      &    0.403   \\
    Health              &   -0.206      &   -0.199   \\
    Study Time          &    0.349      &    0.353   \\
    Family Relations    &    0.279      &    0.247   \\
    Age                 &   -0.226      &   -0.196   \\
    Romantic Relation   &   -0.496      &   -0.461   \\
    Internet Access     &    0.609      &    0.614   \\
    Family Size         &   -0.454      &   -0.353   \\
    Father's Job        &    0.213      &    0.205   \\
    Area (Urban/Rural)  &    0.244      &    0.192   \\
    Family Support      &   -0.267      &   -0.152   \\ 
    Weekly Alcohol Cons.&   -0.129      &   -0.113   \\
    Mother's Job        &    0.125      &    0.066   \\
    Travel Time to School & -0.110      &   -0.053   \\
    Parents Rel. Status &    0.267      &    0.045   \\    
    Daily Alcohol Cons. &   -0.072      &   -0.029   \\ 
    Paid Extra Classes  &   -0.038      &    0.   \\      
    Extra Activities    &    0.013      &    0.   \\    
    Free Time           &   -0.060      &    0.   \\    
    Absences            &    0.003      &    0.   \\
    Father's Education  &    0.042      &    0.   \\         
    Student Guardian    &   -0.057      &    0.   \\    
    Sex                 &    0.120      &    0.   \\
    \bottomrule
  \end{tabular}
\end{table}
...
Figure 2 plots the estimated coefficients for the predictor variables in the 
ridge regression model (L2) as a function of the log values of lambda (x-axis)
and number of features. As the values of lambda become very large, the model
shrinks the coefficient values of non-relevant predictor variables towards zero, 
but the values are never equal exactly to zero. Cross-validation was used to 
select the best value of lambda, which was a value around 0. 



The features with the highest 
...
Table 5 shows the coefficients for the lasso regression plotted as a function 
...
Figure 7, a model that includes 
