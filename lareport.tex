...
was 19.687, which was higher than the random forests regression model. 
...
The results revealed that the different models identified many of the same 
features as important for predicting student performance. The models differed 
in the number of variables and ordering of their respective importance. 



student performance was better in Portugese than 
...
the final general linear model with 13 independent variables provided a 
solution that was simpler and more parsimonious than the lasso model. 
...
In the general linear regression, significance tests are used to select 
significant predictors of the target outcome and non-significant predictors 
are excluded from the revised final model.
