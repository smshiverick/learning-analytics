...
Transformed variables must be converted back to their original scales for 
meaningful interpretation of the results. Furthermore, it may not be feasible to
assess the broader construct of learning using a single measure of performance 
such as a final course grade. A thorough comparison of different predictive
models could include multiple dependent measures.
