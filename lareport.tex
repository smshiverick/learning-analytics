...
validation was used to determine the optimal tree complexity. Using a maximum 
depth of 3, the algorithm returned a regression tree with 7 terminal nodes. 
Figure 4 shows the pruned decision tree with course subject as the root node.
Course subject was a dummy variable and the branch to the left represents 
students in the mathematics course (39\%) and the branch to the right 
represents students in the Portugese course (61\%). The four features used
to construct the regression tree were mother's education level, weekly study 
time. absences, and age.

The regression tree was evaluated on the test set which returned a 


Following the left branch for the mathematics course, the next 
node split on absences; for students with no absences, the next node split
on age, with 4\% of students less than 18 years of age and 9\% of students
18 years or older. Of the 26\% of students in mathetmatics, 16\% had between
1 and 7 absences, whereas 11\% had more than 7 absences. 
...
in the residual mean variance of 3.18.  
