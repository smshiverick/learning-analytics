...
and mother's job (in descending order). The gradient boosted regression had a 
higher model error than for the random forests regression, which was surprising, 
given that the gradient boosted model tries to iteratively correct for mistakes 
...
single measure of performance such as a final course grade.
