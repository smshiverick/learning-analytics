...
higher education, weekly study time, romantic relationships) play an important 
role in predicting student performance. A secondary issue involves the 
reliability of self-report survey data. It can be difficult to obtain reliable 
...
a student survey; however, it would be preferable to analyze behavioural data
to better understand factors that contribute to student learning and performance. 
The development of EDM and LA has primarily been driven by big data in education 
and the shift toward online learning. Much LA/EDM research data is collected 
within a learning management system (LMS), virtual learning environment (VLE), 
or massive open online course (MOOC). Many online platforms allows instructors
to automatically track data on student behavior and participation in real time, 
...
for successful learning and inform decision making \cite{hora19}. Researchers
have examined both quantitative measures about activities and behavior and
qualitative measures about content or affective states (e.g., boredom, 
frustration, confusion) to model student engagement in learning activities.
In turn, these findings can help instructional designers or software to 

respond 
to individual differences and present resources tailed to a learner's needs. 
\cite{pardos14}.


In addition to quantitative measures, meaningful analytics systems will include 


The ability to mine large scale data from 
LMS) and  obtain 

 Online learning platforms suffer from other problems such as 
student attention, retention, and gaming the system \cite{baker14}. 
