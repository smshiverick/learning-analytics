...
student performance, but the models differed in the number, weighting, order and 
importance they gave to the predictor variables. Course subject was selected as 
an important predictor of performance in all of the models; students in the 
Portugese course performed better than students in mathematics. Linear regression 
selected thirteen predictors of student performance in the training set, of which, 
six were significant in the test set. Plans for higher education, mother's 
education level, and weekly study time were positively correlated with student 
performance, whereas course subject, school support, and romantic relations were
negatively associated with performance. 

The regression trees model . 
...
\cite{baker14, pardos14}. In addition, LA/EDM researhers have investigated
