...
towards zero. Regularization reduces variablity, which in turn improves 
model accuracy with new observations, with a slight increase in bias. 
Shrinking the coefficient estimates of irrelevant features toward zero 
reduces overfitting and can aid model interpretation. 
