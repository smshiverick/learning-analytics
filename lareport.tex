...
create the training set ($n_1$=731) and testing set ($n_2$=313). The following 
models were constructed on the training data and evaluated on the test set 
using R including: multivariate linear regression, ridge regression (L2 
penalty), lasso regression (L1 Penalty), regression trees, random forests
regression, and gradient boosted regression. 
...
positively intercorrelated (all \textit{p}s$<$0.001). The first and second course 
