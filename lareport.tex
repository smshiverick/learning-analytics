...
students by attribute. Student performance did not vary significantly 
according to sex ( $\chi 2$, \textit{p}$=$0.20); the performance of male and 
female students did not vary significantly. Performance did vary significantly 
by course topic ($\chi 2$ , \textit{p}$<$0.001); more than two-thirds of 
students in the Portugese course successfully passed, whereas just over half 
of students in the Math course received a passing grade. There relationship 
between performance and students' plans for higher education was also significant 
($\chi 2$ , \textit{p}$<$0.001). Two-thirds of students who received a passing 
grade had plans to pursue higher education, whereas less than one-quarter of 
students with no plans for higher education passed their courses. In other words, 
of students with plans for higher education, one-third received a failing grade; 
by contrast, the majority of students who received a failing grade had no plans 
to pursue higher education. 


The proportion of passing and failing grades varied by level of mother's 
education ($\chi 2$ , \textit{p}$<$0.05); however,  he relationship was 
non-linear. 



however, Extra educational 
...
two-thirds of students who did not receive extra support. In addition, 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 

Study time was significantly associated with student performance 
...
compared to students without home internet access ($\chi 2$ , \textit{p}$<$0.05).
...
The different models identified many of the same features as important for 
predicting student performance. The models differed, however, in the number of 
variables and ordering of their respective importance. 
...
, which was higher than the random forests regression model. 
In contrast to the 
single regression tree and random forest model.
