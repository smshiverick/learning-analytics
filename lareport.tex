...
survey and school grade records. The data were fit using several supervised 
learning regression models (described above). The predictor variables of 
interest were demographic features, family characteristics, and student 
behaviors (e.g., weekly study hours, romantic relationships). The different 
models explored various dimensions of student performance by: (i) Analyzing 
the combination of factors that best predict student performance, (ii) 
Selecting the variables most important for predicting performance, and 
(iii) Identifying the most accurate and interpretable model of predicted 
student performance. 
