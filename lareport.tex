...
\begin{table}
  \caption{Correlation Matrix of Grade Variables (Target Variable = Grade 3)}
  \label{tab:freq}
  \begin{tabular}{llll}
    \toprule
    Variable    & Grade 1 & Grade 2 & Grade 3 (Final) \\
    \midrule
    Grade 1     &  1,00     & 0.86***   &  0.81***  \\
    Grade 2     &  0.86***  & 1.00      &  0.91***  \\  
    Grade 3     &  0.81***  & 0.91***   &  1.00     \\    
    \bottomrule
    Note. *** \textit{p}$<$0.01 & & &
  \end{tabular}
\end{table}
